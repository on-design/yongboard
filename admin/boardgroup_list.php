...
<div class="anchor">
    <ul>
        <li><a href="<?php echo G5_ADM_URL?>/board_list.php">게시판관리</a></li>
        <li><a class="on" href="<?php echo G5_ADM_URL?>/boardgroup_list.php">게시판그룹관리</a></li>
...
<div class="add_btn_wrap">
    <a href="./boardgroup_form.php" id="bo_gr_add" class="btn_add btn01">게시판그룹 추가</a>
</div>
<?php } ?>
...
<div class="btn_list01 btn_list">
    <input type="submit" name="act_button" class="btn_modify btn01" onclick="document.pressed=this.value" value="선택수정">
    <input type="submit" name="act_button" class="btn_delete btn01" onclick="document.pressed=this.value" value="선택삭제">
    <a href="./boardgroup_form.php" class="btn01 btn_add">게시판그룹 추가</a>
</div>
</form>
