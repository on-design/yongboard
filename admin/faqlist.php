...
<div class="anchor">
    <ul>
        ...
        <li><a class="on" href="<?php echo G5_ADM_URL?>/faqlist.php?fm_id=1">FAQ관리</a></li>
    </ul>
</div>

<div class="local_ov01 local_ov">
    등록된 FAQ 내용 <?php echo $total_count; ?>건
</div>

<div class="local_desc01 local_desc">
    <ol>
        <li>FAQ는 무제한으로 등록할 수 있습니다</li>
        <li><strong>FAQ 내용 추가</strong>를 눌러 자주하는 질문과 답변을 입력합니다.</li>
    </ol>
</div>

<div class="add_btn_wrap">
    <a href="./faqform.php?fm_id=<?php echo $fm['fm_id']; ?>" class="btn_add btn01">FAQ 내용 추가</a>
</div>
