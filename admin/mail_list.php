...
<div class="anchor">
    <ul>
        <li><a href="<?php echo G5_ADM_URL?>/member_list.php">회원관리</a></li>
        <li><a class="on" href="<?php echo G5_ADM_URL?>/mail_list.php">회원메일발송</a></li>
    </ul>
</div>
...
<div class="add_btn_wrap">
    <a href="./mail_form.php" id="mail_add" class="btn01 btn_add">메일내용추가</a>
</div>
...
<div class="btn_list">
    <input type="submit" value="선택삭제" class="btn01 btn_delete">
</div>
</form>
