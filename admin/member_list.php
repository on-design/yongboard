...
<div id="admTitle">
    <h2><i class="xi-user"></i>회원관리</h2>
</div>
<div class="anchor">
    <ul>
        <li><a class="on" href="<?php echo G5_ADM_URL?>/member_list.php">회원관리</a></li>
        <li><a href="<?php echo G5_ADM_URL?>/mail_list.php">회원메일발송</a></li>
    </ul>
</div>
<div id="memberList">
    ...
    <div class="add_btn_wrap">
        <a href="./member_form.php" id="member_add" class="btn01 btn_add">회원추가</a>
    </div>
    <?php } ?>
    <div class="search_wrap">
        ...
        <input type="submit" class="btn_submit btn01" value="검색">
    ...
    <div class="btn_list">
        <input type="submit" name="act_button" class="btn01 btn_modify" value="선택수정" onclick="document.pressed=this.value">
        <input type="submit" name="act_button" class="btn01 btn_delete" value="선택삭제" onclick="document.pressed=this.value">
    </div>
