...
<div class="anchor">
    <ul>
        ...
        <li><a href="<?php echo G5_ADM_URL?>/sms_admin/member_update.php">회원정보업데이트</a></li>
        ...
        <li><a class="on" href="<?php echo G5_ADM_URL?>/sms_admin/num_book.php">휴대폰번호 관리</a></li>
...
<div class="add_btn_wrap">
    <a href="./num_book_write.php?page=<?php echo $page?>&amp;bg_no=<?php echo $bg_no?>" class="btn_add btn01">번호추가</a>
</div>
...
<div class="btn_list01 btn_list">
    <input type="submit" name="act_button" class="btn01" value="선택삭제" onclick="document.pressed=this.value">
    <input type="submit" name="act_button" class="btn01" value="수신허용" onclick="document.pressed=this.value">
    <input type="submit" name="act_button" class="btn01" value="수신거부" onclick="document.pressed=this.value">
    <input type="submit" name="act_button" class="btn01" value="선택이동" onclick="document.pressed=this.value">
    <input type="submit" name="act_button" class="btn01" value="선택복사" onclick="document.pressed=this.value">
</div>
</form>
<script>
