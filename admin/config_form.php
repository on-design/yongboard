...
$frm_submit = '<div class="btn_confirm">
    <input type="submit" value="확인" class="btn01 btn_success" accesskey="s">
</div>';
...
<div id="admTitle">
    <h2><i class="xi-cog"></i>환경설정</h2>
</div>
<div class="anchor">
    <ul>
        <li><a class="on" href="#anc_cf_basic" rel="#anc_cf_basic">기본정보</a></li>
        <li><a href="#anc_cf_join" rel="#anc_cf_join">회원가입</a></li>
        <li><a href="#anc_cf_cert" rel="#anc_cf_cert">본인확인</a></li>
        <li><a href="#anc_cf_sns" rel="#anc_cf_sns">SNS</a></li>
        <li><a href="#anc_cf_sms" rel="#anc_cf_sms">SMS</a></li>
    </ul>
</div>
<div id="configform">
    ...
    <section id="anc_cf_basic" class="tab_content">
        <div class="cf_default box_wrap">
            <h2 class="box_header">사업자 정보</h2>
            <div class="box_content">
                <dl>
                    <dt>홈페이지 제목</dt>
                    <dd>
                        <input type="text" name="cf_title" value="<?php echo $config['cf_title'] ?>" id="cf_title" required class="required frm_input">
                    </dd>
                </dl>
                <dl>
                    <dt>상호(회사명)</dt>
                ...
                <dl>
                    <dt>대표 이메일</dt>
                    <dd>
                        <input type="text" name="cf_admin_email" value="<?php echo $config['cf_admin_email'] ?>" id="cf_admin_email" required class="required email frm_input">
                    </dd>
                </dl>
                <dl class="wid_full">
                    <dt>사업장 주소</dt>
                    <dd><input type="text" class="frm_input" size="50"></dd>
                </dl>
            </div>
        </div>
        <div class="cf_ip box_wrap">
            <h2 class="box_header">접근 IP관리</h2>
            <div class="box_content">
                <dl>
                    <dt>접근가능 IP</dt>
                    <dd>
        ...
        <div class="cf_tag box_wrap">
            <h2 class="box_header">SEO 설정</h2>
            <div class="box_content">
                <dl>
                    <dt>방문자분석 스크립트</dt>
                    <dd>
    ...
    <section id="anc_cf_join" class="tab_content">
        <div class="box_wrap">
            <h2 class="box_header">회원가입 설정</h2>
    ...
    <section id="anc_cf_cert" class="tab_content">
        <div class="box_wrap">
            <h2 class="box_header">본인확인 설정</h2>
            <div class="box_content cert_opt">
                <div>
                    <dl>
                        <dt>본인확인</dt>
                        <dd>
        ...
        <div class="box_wrap">
            <h2 class="box_header">본인확인 설정</h2>
            <div class="box_content cert_tbl">
                <table>
                ...
                <tr>
                    ...
                    <td class="cf_cert_service">
                        ...
                        <a href="http://sir.kr/main/service/b_ipin.php" target="_blank" class="btn_frmline">KCB 아이핀 서비스 신청페이지</a>
    ...
    <section id="anc_cf_sns" class="tab_content">
        <div class="box_wrap">
            <h2 class="box_header">소셜네트워크서비스(SNS : Social Network Service)</h2>
            <div class="box_content">
                <table>
    ...
    <section id="anc_cf_sms" class="tab_content">
        <div class="box_wrap">
            <h2 class="box_header">SMS</h2>
            <div class="box_content">
                <table>
...
<script type="text/javascript">
    $(document).ready(function() {
        $('.anchor ul li a').on('click', function(event) {
            event.preventDefault();
            $('.anchor ul li a').removeClass('on');
            $(this).addClass('on');
            $('.tab_content').css({
                height: '0',
                overflow: 'hidden',
